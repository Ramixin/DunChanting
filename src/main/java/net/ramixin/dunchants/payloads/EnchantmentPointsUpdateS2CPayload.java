package net.ramixin.dunchants.payloads;
...
public record EnchantmentPointsUpdateS2CPayload(int value) implements CustomPayload {
    ...
    public static final CustomPayload.Id<EnchantmentPointsUpdateS2CPayload> PACKET_ID = new CustomPayload.Id<>(DungeonEnchants.id("enchantment_points_update"));
