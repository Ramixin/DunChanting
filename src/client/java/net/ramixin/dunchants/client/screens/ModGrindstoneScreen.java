...
import net.ramixin.dunchants.client.enchantmentui.grindstone.GrindstoneElement;
...
public class ModGrindstoneScreen extends HandledScreen<ModGrindstoneScreenHandler> implements EnchantmentUIHolder {
    ...
    public static final Identifier BACKGROUND = DungeonEnchants.id("textures/gui/container/grindstone.png");
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, BACKGROUND, i, j, 0.0F, 0.0F, this.backgroundWidth, this.backgroundHeight, 256, 256);
    }
